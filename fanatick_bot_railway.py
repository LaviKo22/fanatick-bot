...
async def process_screenshot(image_bytes, status_callback):
    ...
    refresh_wallet_links(identifiers)
    ...
    for m in matched:
        ...
        wallet = detail.get("wallet_links", {})
        passes_with_links.append({
            ...
            "row": m.get("row", ""),
            "seat": m.get("seat", ""),
            "apple_wallet_link": wallet.get("apple", "N/A"),
            "google_wallet_link": wallet.get("google", "N/A"),
            "status": m.get("status", "")
        })
